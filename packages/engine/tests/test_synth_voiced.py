"""Tests for the opt-in voiced (pitch/F0) synthesis mode in ``cr_engine.synth``.
...
from cr_engine import DEFAULT_F0_HZ, SYNTH_SR, make_scene, make_speaker_stems
from cr_engine.diarize import pitch_stats
